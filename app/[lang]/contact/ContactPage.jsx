        ...
        <div className="BRANCHESMain grid grid-cols-3 gap-6">
          <div className="BRANCHESMainBox border-4 border-[#393946]  relative bg-[#393946] text-white rounded-3xl text-center">
              <div className="BRANCHESMainBox_top py-6 px-5">
                <div className="h2 text-[2.2rem] font-medium font-Mluvka">{datas?.sec_two_sub_head_one}</div>
                <p className='min-h-[3rem]'>{datas?.sec_two_location_one}</p>
                <a href={`tel:${datas?.sec_two_phone_one}`} className="text-secondary text-[2.3rem] block font-Mluvka">{datas?.sec_two_phone_one}</a>
              ...
              <div className="BRANCHESMainBox_bottom">
                <iframe className="w-full h-[15rem] " style={{"borderRadius": "0 0 1.5rem 1.5rem"}} src={datas?.sec_two_url_one} allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
              </div>
          </div>
          <div className="BRANCHESMainBox border-4 border-[#393946]  relative bg-[#393946] text-white rounded-3xl text-center">
              <div className="BRANCHESMainBox_top py-6 px-5">
                <div className="h2 text-[2.2rem] font-medium font-Mluvka">{datas?.sec_two_sub_head_two}</div>
                <p className='min-h-[3rem]'>{datas?.sec_two_location_two}</p>
                <a href={`tel:${datas?.sec_two_phone_two}`} className="text-secondary text-[2.3rem] block font-Mluvka">{datas?.sec_two_phone_two}</a>
                <a href={`mailto:${datas?.sec_two_email_two}`} className="text-[1.5rem] font-bold font-Mluvka">{datas?.sec_two_email_two}</a>
              </div> 
              <div className="BRANCHESMainBox_bottom">
                <iframe className="w-full h-[15rem] " style={{"borderRadius": "0 0 1.5rem 1.5rem"}} src={datas?.sec_two_url_two} allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
              </div>
          </div>
          <div className="BRANCHESMainBox border-4 border-[#393946]  relative bg-[#393946] text-white rounded-3xl text-center">
              <div className="BRANCHESMainBox_top py-6 px-5">
                <div className="h2 text-[2.2rem] font-medium font-Mluvka">{datas?.sec_two_sub_head_three}</div>
                <p className='min-h-[3rem]'>{datas?.sec_two_location_three}</p>
                <a href={`tel:${datas?.sec_two_phone_three}`} className="text-secondary text-[2.3rem] block font-Mluvka">{datas?.sec_two_phone_three}</a>
                <a href={`mailto:${datas?.sec_two_email_three}`} className="text-[1.5rem] font-bold font-Mluvka">{datas?.sec_two_email_three}</a>
              </div> 
              <div className="BRANCHESMainBox_bottom">
                <iframe className="w-full h-[15rem] " style={{"borderRadius": "0 0 1.5rem 1.5rem"}} src={datas?.sec_two_url_three} allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
              </div>
          </div>
        </div>
      </div>
