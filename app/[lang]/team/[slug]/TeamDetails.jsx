    ...
    <div className='container mx-auto'>
      <div className='teams grid grid-cols-[2fr,8fr] max-[1400px]:grid-cols-[3fr,8fr] gap-10 items-center max-lg:grid-cols-1'>
        <div className='teams__left'>
          <Image src={lowyer_image} className='w-full h-[35rem]  object-cover rounded-[5rem]' width={10} height={10} alt={name ?? ""} />
        </div>
     ...
     {qr_code_image && <div className='  pt-5'>
        <Image className='w-[10rem]' src={qr_code_image ?? ""} alt='team_qr_code' width={0} height={0} />
      </div>}
