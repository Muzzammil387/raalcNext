            ...
            <div className="container mx-auto">
              ...
              <div className="cardMain3Box " key={index}>
                ...
                <div className="cardMain3BoxBody bg-[#FFFDFA] p-4">
                  ...
                  <Link href={`/${basePath}events/${slug}`} className="mt-4 block w-fit border border-secondary rounded-full  font-bold capitalize text-center py-2 px-8 mb-4 font-Mluvka ">{elements?.["read-more"]}</Link>
                </div>
            </div>
            )
            })}
