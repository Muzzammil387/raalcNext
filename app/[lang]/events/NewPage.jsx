...
const formatDate = (dateString, langValue) => {
  const date = dayjs(dateString);

  if (langValue === 'ar') {
    dayjs.locale('ar');
    return {
      monthYear: date.format('D MMMM, YYYY').toLocaleString('ar-EG'), // Arabic date format with Arabic numerals
    };
  } else {
    dayjs.locale('en');
    return {
      monthYear: date.format('MMMM D, YYYY'), // English date format
    };
  }
};
