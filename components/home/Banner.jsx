...
const Banner = () => {
  return (
    ...
    <div className="bannertxt max-lg:text-[2.438rem] w-[29.938rem] absolute top-[45%] transform translate-y-[-50%] text-center mx-auto left-0 right-0 text-white text-[3.75rem] leading-9">
      <span className="font-MrDeHaviland relative top-[-1rem]">your</span>
      <span className="font-semibold font-Saira uppercase">Advocate</span>
      <span className="font-Saira font-normal uppercase">for Fair</span>
      <span className="font-MrDeHaviland">&</span>
      <span className="font-Saira font-normal uppercase">Just Outcomes</span>
    </div>

    <div className="bannertxt2 absolute bottom-0 left-36 max-lg:relative text-center max-lg:left-0">
      <span className="leading-4 font-bold block relative">We Will Fight To Get You The Best <br />
