import { banner3, facebook, intragram, linkdin, logo, whatsapp } from '@/app/untils/imgimport'
...
const Footer = () => {
    ...
    <div className="w-[20rem] h-[20rem] bg-secondary opacity-[6]  blur-[15rem] absolute right-0 bottom-[-10rem]"></div>
     <div className="js--marque-a">
      <div className="b--marque-a__content ">
        ...
        <div className="h5 text-[#F4EEE4] uppercase text-[9rem] font-light text-center ">Know Your Rights</div>
        <div className="h5 text-[#F4EEE4] uppercase text-[9rem] font-light text-center ">Know Your Rights</div>
      </div>
      </div>
    </div>
  <div className="footer__top relative">
    ...
    <div className="footer__topBox grid grid-cols-2 gap-3">
      <ul>
           <li className="my-3"><Link href="index.html" className="font-cormorant font-medium capitalize">Home</Link></li>
        <li className="my-3"><Link href="about.html" className="font-cormorant font-medium capitalize">about</Link></li>
        <li className="my-3"><Link href="services.html" className="font-cormorant font-medium capitalize">services</Link></li>
        <li className="my-3"><Link href="/" className="font-cormorant font-medium capitalize">expertise</Link></li>
      </ul>
      <ul>
        <li className="my-3"><Link href="/" className="font-cormorant font-medium capitalize">diversity</Link></li>
        <li className="my-3"><Link href="/" className="font-cormorant font-medium capitalize">legal library</Link></li>
        <li className="my-3"><Link href="/" className="font-cormorant font-medium capitalize">Other Service</Link></li>
      </ul>
    </div>
    <div className="footer__topBox">
      <Link href="/" className="block border border-secondary rounded-full font-cormorant font-bold capitalize text-center py-2 mb-4">Get a Quote</Link>
      <Link href="/" className="block bg-secondary rounded-full font-cormorant font-bold capitalize text-center py-2">Download Our Company Profile</Link>
      <br />
      <div className="flex gap-2">
        <div className="h6 font-cormorant font-bold text-[1.2rem]">Connect with us</div>
        <ul className="list flex gap-3">
          <li>
            <Link href="/"><Image className="magnetic" src={facebook} alt="facebook.svg" /></Link>
          </li>
          <li>
            <Link href="/"><Image className="magnetic" src={intragram} alt="intragram.svg" /></Link>
          </li>
          <li>
            <Link href="/"><Image className="magnetic" src={linkdin} alt="linkdin.svg" /></Link>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div className="container items-end mx-auto px-14 grid grid-cols-3 gap-5 max-lg:grid-cols-1 max-lg:px-0">
      <div className="footer__bottomBox">
        ...
        <ul className="list font-medium">
          <li><span>Email:</span><Link href="/" className="border-b border-black">info@raalc.ae</Link></li>
          <li><span>Phone:</span><Link href="/" className="border-b border-black">+97145693370,</Link> <span>Fax</span> <Link href="/" className="border-b border-black">+97145693382</Link></li>
        </ul>
      </div>
      <div className="footer__bottomBox">
        ...
        <ul className="list font-medium">
          <li><span>Email:</span><Link href="/" className="border-b border-black">info@raalc.ae</Link></li>
          <li><span>Phone:</span><Link href="/" className="border-b border-black">+97165370010,</Link> <span>Fax</span> <Link href="/" className="border-b border-black">+97165370012</Link></li>
        </ul>
      </div>
      <div className="footer__bottomBox">
  ...
  <div
    ...
    <div className="bannerRightBOx p-2 bg-[#30303D] rounded-full w-[3.188rem] h-[3.188rem] border-setext-secondary border-2">
      <Image className="w-full h-full object-cover rounded-full" src={banner3} alt="3.png" />
    </div>
